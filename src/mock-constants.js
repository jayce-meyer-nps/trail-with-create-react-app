export const MOCK_FEATURE_POINT_OF_INTEREST = `{
    "type": "Feature",
...
export const MOCK_FEATURE_TRAIL_DATA_WITH_ELEVATION = `{
...
export const MOCK_FEATURE_TRAIL_ALERTS = `{
...
export const myElevationProfileOptions = {
